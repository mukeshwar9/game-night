...
export default function JoinRoomSheet({ code, onChange, onJoin, onClose }) {
  return (
    <BottomSheet onClose={onClose} ariaLabel="Join a game room" className="space-y-4">
      ...
      <button
        onClick={onJoin}
        className="w-full min-h-12 flex items-center justify-center bg-retro-cta text-retro-bg
