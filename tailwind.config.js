  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon-p3':  '0 0 8px rgb(var(--c-p3)), 0 0 24px rgb(var(--c-p3) / 0.35)',
        'neon-p4':  '0 0 8px rgb(var(--c-p4)), 0 0 24px rgb(var(--c-p4) / 0.35)',
  ...
  plugins: [
    function ({ addUtilities }) {
      addUtilities({
        ...
        '.text-glow-p3':  { textShadow: '0 0 8px rgb(var(--c-p3)), 0 0 20px rgb(var(--c-p3) / 0.5)' },
        '.text-glow-p4':  { textShadow: '0 0 8px rgb(var(--c-p4)), 0 0 20px rgb(var(--c-p4) / 0.5)' },
